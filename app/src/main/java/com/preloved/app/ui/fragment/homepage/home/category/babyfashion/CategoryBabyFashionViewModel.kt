...
class CategoryBabyFashionViewModel(
    private val categorySmartphoneRepository: CategoryBabyFashionRepository
): BaseViewModellmpl(), CategoryBabyFashionContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categorySmartphoneRepository.getDataCategoryById(categoryId)
