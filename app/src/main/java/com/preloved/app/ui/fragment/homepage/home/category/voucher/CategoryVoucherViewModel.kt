...
class CategoryVoucherViewModel(
    private val categoryVoucherRepository: CategoryVoucherRepository
): BaseViewModellmpl(), CategoryVoucherContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryVoucherRepository.getDataCategoryById(categoryId)
