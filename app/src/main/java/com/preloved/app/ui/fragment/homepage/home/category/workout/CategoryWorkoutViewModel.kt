...
class CategoryWorkoutViewModel(
    private val categoryWorkoutRepository: CategoryWorkoutRepository
): BaseViewModellmpl(), CategoryWorkoutContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryWorkoutRepository.getDataCategoryById(categoryId)
