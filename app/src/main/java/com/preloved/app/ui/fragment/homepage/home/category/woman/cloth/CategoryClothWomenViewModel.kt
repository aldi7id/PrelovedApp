...
class CategoryClothWomenViewModel(
    private val categoryClothWomenRepository: CategoryClothWomenRepository
): BaseViewModellmpl(), CategoryClothWomenContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryClothWomenRepository.getDataCategoryById(categoryId)
