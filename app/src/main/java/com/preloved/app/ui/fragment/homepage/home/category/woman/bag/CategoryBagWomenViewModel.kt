...
class CategoryBagWomenViewModel(
    private val categoryBagWomenRepository: CategoryBagWomenRepository
): BaseViewModellmpl(), CategoryBagWomenContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryBagWomenRepository.getDataCategoryById(categoryId)
