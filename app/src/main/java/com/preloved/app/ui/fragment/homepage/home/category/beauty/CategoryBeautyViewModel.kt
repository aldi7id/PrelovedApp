...
class CategoryBeautyViewModel(
    private val categoryBeautyRepository: CategoryBeautyRepository
): BaseViewModellmpl(), CategoryBeautyContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryBeautyRepository.getDataCategoryById(categoryId)
