...
class CategoryFashionMuslimViewModel(
    private val categoryFashionMuslimRepository: CategoryFashionMuslimRepository
): BaseViewModellmpl(), CategoryFashionMuslimContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryFashionMuslimRepository.getDataCategoryById(categoryId)
