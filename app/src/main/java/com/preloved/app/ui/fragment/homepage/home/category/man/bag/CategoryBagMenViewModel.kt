...
class CategoryBagMenViewModel(
    private val categoryBagMenRepository: CategoryBagMenRepository
): BaseViewModellmpl(), CategoryBagMenContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryBagMenRepository.getDataCategoryById(categoryId)
