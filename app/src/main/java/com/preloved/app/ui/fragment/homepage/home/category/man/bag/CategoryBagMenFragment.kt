...
class CategoryBagMenFragment : BaseFragment<FragmentCategoryBagMenBinding, CategoryBagMenViewModel>(
    FragmentCategoryBagMenBinding::inflate
), CategoryBagMenContract.View {
    override val viewModel: CategoryBagMenViewModel by viewModel()
