...
class CategoryMomAndBabyViewModel(
    private val categoryMomAndBabyRepository: CategoryMomAndBabyRepository
): BaseViewModellmpl(), CategoryMomAndBabyContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryMomAndBabyRepository.getDataCategoryById(categoryId)
