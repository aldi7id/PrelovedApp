...
class CategoryShoesMenViewModel(
    private val categoryShoesMenRepository: CategoryShoesMenRepository
): BaseViewModellmpl(), CategoryShoesMenContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryShoesMenRepository.getDataCategoryById(categoryId)
