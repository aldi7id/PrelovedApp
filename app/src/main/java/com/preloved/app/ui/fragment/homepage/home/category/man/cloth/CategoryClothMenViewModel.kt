...
class CategoryClothMenViewModel(
    private val categoryClothMenRepository: CategoryClothMenRepository
): BaseViewModellmpl(), CategoryClothMenContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryClothMenRepository.getDataCategoryById(categoryId)
