...
class CategoryPhotographerViewModel(
    private val categoryPhotographerRepository: CategoryPhotographerRepository
): BaseViewModellmpl(), CategoryPhotographerContract.ViewModel {
    ...
    override fun getDataById(categoryId: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val responseData = categoryPhotographerRepository.getDataCategoryById(categoryId)
