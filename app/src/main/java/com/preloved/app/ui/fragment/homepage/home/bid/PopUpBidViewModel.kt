...
class PopUpBidViewModel(
    ...
    override fun getBidProductOrderResult(): MutableLiveData<Resource<GetBidResponse>> =
        getDataBidProduct

    override fun postBidProductOrderByIdResult(): MutableLiveData<Resource<PostBidResponse>> =
        postDataBidProduct
